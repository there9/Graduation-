...
public:
	...
	void	BlobBigSizeWidthConstraint(int nWidth);
	void	BlobBigSizeHeightConstraint(int nHeight);
	void    Blob_X_SmallSort();
private:
	void	_BlobBigSizeConstraint(int nWidth, int nHeight, CvRect* rect, int* nRecNumber);
	void	_BlobBigSizeWidthConstraint(int nWidth, CvRect* rect, int* nRecNumber);
	void	_BlobBigSizeHeightConstraint(int nHeight, CvRect* rect, int* nRecNumber);
};